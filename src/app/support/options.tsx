...
const Options_body = () => {
  ...
  return (
    <>
      <div className="w-full py-[6vw] px-[2vw] flex justify-center items-center">
        {step == 0 && (
          <div className="flex w-[45vw] flex-wrap h-auto  justify-between gap-[1vw] ">
            {items.map((e: any, index: any) => {
              return (
                <div
                  ...
                  className="h-[8vw] rounded-[1vw] bg-[#111111] cursor-pointer hover:bg-opacity-[70%] duration-[0.6s] transition flex-col w-[14vw] flex justify-center items-center gap-[1vw] "
                >
                  <Image src={e.img} alt={e.text} className="w-[1.5vw] h-fit" />
