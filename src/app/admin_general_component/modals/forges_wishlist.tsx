...
export default function ForgesWishList({ name, handleModalPopUp }: ModalPropsTypes) {
  return (
    <dialog
      id="forges_wishlist"
      className="modal bg-[rgba(0,0,0,0.80)] overflow-y-auto"
    >
      <div className="relative gap-3 bg-[#fff] mb-[2rem] w-[95%] dsm:w-[80%] md:w-[90%] lg:w-[auto] h-auto rounded-[30px] flex flex-col items-center p-[20px] dsm:p-[43px] lg:p-[70px] pt-[70px] pb-3 dsm:pb-3 lg:pb-3">
