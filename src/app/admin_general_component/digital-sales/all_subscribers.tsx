...
const AllSubscribers = ({
  ...
  return (
    <div className="flex flex-col items-start w-[95%] lg:w-[90%] ml-auto lg:ml-0 h-auto bg-[#FFF] rounded-br-none rounded-tr-none rounded-tl-[30px] rounded-bl-[30px]  lg:rounded-[30px] p-[20px] flex-wrap">
      <SubscriberTypeTggle digitalSalesData={digitalSalesData}/>
      <div className="overflow-x-auto w-full max-w-[100rem] lg:max-w-none  lg:w-full mt-[15px] lg:mt-[30px]">
        <table className="table table-xs table-pin-rows">
          ...
          <tbody>
            {digitalSalesData?.map((data, i) => (
              <tr
                key={i}
                className="w-auto  border-b-[rgba(0,0,0,0.12)] hover:bg-slate-100"
              >
                <td
                  onClick={() => {
                    handleModalPopUp("my_modal_3", data?.userid);
                  }}
                  // onClick={() => handleModalPopUp("my_modal_3", data?.userid)}
                  className="cursor-pointer min-w-[200px] lg:min-w-0 p-2 whitespace-break flex flex-row items-center py-2 gap-[16px] "
                >
                  <Image
                    height="0"
                    width="0"
                ...
                <td className="min-w-[200px] lg:min-w-0 p-2 whitespace-break flex items-center justify-start gap-3 text-[14px] text-[#000] nueuem font-medium leading-[129%]">
                  <div className="avatar-group -space-x-2 rtl:space-x-reverse">
                    {data.forges.slice(0, 4).map((f: any, i2: number) => (
                      <div key={i2} className="avatar border-none">
                  ...
                  {/* <div className="avatar-group -space-x-3 rtl:space-x-reverse">
                    <div className="avatar border-none">
                      <div className="w-[20px] lg:w-[35px] h-[20px] lg:h-[35px]">
                        <Image
                          ...
                          height="0"
                          width="0"
                          src="/admin_section/general/con1.png"
                          className="w-full"
                        />
                      </div>
                    </div>
                    <div className="avatar border-none">
                      <div className=" w-[20px] lg:w-[35px] h-[20px] lg:h-[35px]">
                        <Image
                          ...
                          height="0"
                          width="0"
                          src="/admin_section/general/con2.png"
                          className="w-full"
                        />
                      </div>
                    </div>
                    <div className="avatar border-none">
                      <div className="w-[20px] lg:w-[35px] h-[20px] lg:h-[35px]">
                        <Image
                          ...
                          height="0"
                          width="0"
                          src="/admin_section/general/con3.png"
                          className="w-full"
                        />
                      </div>
                    </div>
                    <div className="avatar border-none">
                      <div
                        className="w-[dataLoaded = true;
    }20px] lg:w-[35px] h-[20px] lg:h-[35px]"
                      >
                        <Image
                          alt="avatar"
                          height="0"
                  ...
                  <p className="min-w-[200px] lg:min-w-0 p-2 whitespace-break text-[11px] lg:text-[14px] neuem font-medium leading-[129%]">
                    {/* 232 forges */}
                    {data?.forges?.length} forges
                  </p>
                  <button
                    onClick={() => {
                      handleModalPopUp("all_forges_downloaded", data?.userid);
                    }}
