    ...
    const fetchData = async () => {
      try {
        ...
        querySnapshot.forEach((doc) => {
          ...
          const week = Math.floor((createdAt.getDate() - 1) / 7);
  ...
  return (
    <div className=" px-[2vw] sm:mb-[15vw] sm:mt-[10vw] ">
      <div className="bg-white w-full rounded-[2vw] px-[3vw] sm:h-auto sm:gap-[5vw]  h-[40vw] flex flex-col gap-[1vw] py-[3vw] mb-[4vw]">
        <h2 className="neuem text-[2.5vw] font-[800] sm:text-[7vw]  ">
        ...
        <div className="flex text-[1vw] items-center gap-[1vw] sm:text-[3vw] w-full justify-between sm:gap-[2vw] ">
          <p>
            All digital sales for the month of {getMonthName(selectedMonth)} :{" "}
          </p>
