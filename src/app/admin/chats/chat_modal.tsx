...
const Moderator_Chats_modal = ({
  ...
  return (
    <>
      ...
      <div
        className={`w-[40vw] sm:translate-y-0 sm:top-0  sm:h-[100vh]  sm:w-full fixed pt-[6.5vw] sm:pt-[25vw] pb-[6vw] rounded-[1vw]  h-[89%] max-h-[96vh] sm:max-h-[100vh]  sm:py-[5vw] px-[1.5vw]  top-[0]   translate-y-[10%]  z-[999]   sm:gap-[4vw]  bg-[#111111] settings flex flex-col gap-[1.5vw] border-[#434343] overflow-hidden ${
