...
const Moderator_header = ({ moderator_size, moderator_is_loading }: any) => {
  ...
  return (
    <>
      <div className="w-full items-center backdrop-blur-[14px] bg-opacity-[30%] z-[99999] bg-black  sticky top-0 text-white left-0 flex justify-start sm:h-[18vw] sm:justify-between  px-[2vw] h-[6vw] gap-[2vw] ">
        <button
