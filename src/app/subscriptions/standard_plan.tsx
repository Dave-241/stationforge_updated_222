...
const StandardPlan = () => {
  ...
  return (
    <>
      <div className="w-[29vw]  h-[50vw] pt-[2vw] pb-[2vw] px-[1.2vw] flex flex-col justify-center items-center  bg-[#111111] rounded-[1.2vw] border-l-[0.5vw] gap-[2vw]  border-[#4C89E5]">
        {/* first row div */}
        <div className="w-full flex justify-between items-center">
          ...
          <h3 className="neuer text-[1.2vw] text-black bg-white py-[0.7vw] px-[1.4vw] rounded-[2.7vw]">
            Most popular{" "}
          </h3>
        </div>
        {/* second row div */}
        <div className="w-full flex  flex-col gap-[0.4vw] pb-[1vw] ">
          <h2 className="text-[2.1vw] text-white neuem">Standard Tier</h2>
          <h3 className="text-white neuer text-opacity-[40%] text-[1vw]">
            Access to monthly releases <br />
            (files are pre-supported)
          </h3>
        </div>
          ...
          {list.map((e: any, index: any) => {
            return (
              <li key={index} className="flex gap-[1.2vw] items-center">
                <Image src={e.img} alt={e.txt} className="w-[3vw] h-fit" />
                <p className="text-[1vw] text-white neuer">{e.txt}</p>
              </li>
            );
          })}
        </ul>
        ...
        <button className="w-full h-[4vw] text-[1.6vw] neuem rounded-[3.7vw] transition duration-[0.2s] hover:bg-[#7e9426] bg-[#CCFF00]">
          Join
        </button>
      </div>{" "}
    </>
