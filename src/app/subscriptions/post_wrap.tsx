...
const Post_wrap = () => {
  ...
  return (
    <>
      <h2 className="text-center neuem text-5xl sm:text-[9vw] text-white capitalize pt-[4rem] pb-[3rem]">
        Our Posts
      </h2>{" "}
      <div className="w-full h-[0.1rem] bg-opacity-[23%] bg-[#D9D9D9] sm:w-[90vw] sm:mx-auto sm:h-[0.5vw] "></div>
      <div className="w-full h-auto sm:h-[5vw]"></div>
      <div className="w-full sm:px-[4vw] sm:gap-[10vw]  flex flex-col gap-[6rem] justify-center pt-[4rem] items-center">
        {!post_loading
